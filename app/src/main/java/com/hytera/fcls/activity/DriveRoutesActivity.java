...
public class DriveRoutesActivity extends Activity implements AMapNaviListener, OnClickListener, OnCheckedChangeListener, LocationSource ,AMapLocationListener{
...
//                this.finish();
    ...
    @Override
    public void onLocationChange(AMapNaviLocation amapLocation) {
